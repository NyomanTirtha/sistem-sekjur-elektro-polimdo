            ...
            <div className="relative z-10 h-full">
              ...
              >
                ...
                <div className="max-w-full h-full">
                  {/* Content Card with Politeknik Branding */}
                  <motion.div 
                  ...
                  >
                    <motion.button 
                      className="w-14 h-14 bg-gradient-to-r from-blue-600 to-blue-400 text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-200 hover:scale-105 flex items-center justify-center group"
