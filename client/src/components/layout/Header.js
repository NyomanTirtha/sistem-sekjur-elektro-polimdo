...
const roleInfo = {
  SEKJUR: {
    ...
    getSubtitle: (u) =>
      u.jurusan?.nama ? `Jurusan ${u.jurusan.nama}` : "Sekretaris Jurusan",
  },
  KAPRODI: {
    label: "Ketua Program Studi",
    getSubtitle: (u) =>
      u.prodi?.nama || u.programStudi?.nama || "Ketua Program Studi",
  },
  DOSEN: {
    label: "Dosen",
    getSubtitle: (u) => u.prodi?.nama || u.programStudi?.nama || "Dosen",
  },
  MAHASISWA: {
    label: "Mahasiswa",
    getSubtitle: (u) => u.programStudi?.nama || u.prodi?.nama || "Mahasiswa",
  },
};
...
const profileFieldsConfig = {
  SEKJUR: [
    ...
    },
    {
      ...
      color: "green",
      custom: (u) =>
        u.jurusan?.nama ? `Data Jurusan ${u.jurusan.nama}` : "Terbatas",
    },
  ],
  MAHASISWA: [
    ...
    },
    {
      ...
      icon: Building2,
      color: "indigo",
      path: "programStudi.jurusan.nama",
    },
  ...
  KAPRODI: [
    ...
    },
    {
      ...
      icon: Users,
      color: "amber",
      custom: (u) => (u.isKaprodi ? "Ketua Program Studi" : "Dosen"),
    },
    { key: "noTelp", label: "No. Telepon", icon: Phone, color: "teal" },
    { key: "alamat", label: "Alamat", icon: MapPin, color: "pink" },
  ],
...
const Header = ({
  ...
  const { changePassword, isLoading, success, resetMessages } =
    usePasswordChange(authToken, currentUser);
  ...
  const renderProfileFields = () => {
    ...
    return fields.map((field) => {
      ...
      let value = field.custom
        ? field.custom(currentUser)
        : field.path
          ? getNestedValue(currentUser, field.path)
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-30 bg-white border-b border-gray-200">
      <div
        className={`h-16 flex items-center justify-between ${sidebarCollapsed ? "pl-20" : "pl-72"}`}
      >
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col">
            ...
            <p className={`text-sm font-medium ${headerAccentClass}`}>
              {subtitle}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="relative mr-7">
            ...
            >
              <div
                className={`w-10 h-10 rounded-full bg-gray-600 flex items-center justify-center border-2 ${avatarBorderClass}`}
              >
                            ...
                            <div className="flex items-center justify-between p-2 bg-white rounded border border-gray-200">
                              ...
                              <span className="text-sm font-semibold text-gray-800">
                                {currentUser.jurusan?.nama
                                  ? `Jurusan ${currentUser.jurusan.nama}`
                                  : "Terbatas"}
                              </span>
                            </div>
                          )}
              ...
              >
                ...
                <div className="p-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-3">
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className={`px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
                  >
